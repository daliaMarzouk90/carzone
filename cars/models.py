...
class car(models.Model):
    ...
    transimission = models.CharField(max_length=100, blank=True)
    interior = models.CharField(max_length=100, blank=True)
    miles = models.CharField(max_length=100, blank=True)
    doors = models.CharField(choices=door_choices, max_length=10)
    passanger = models.CharField(max_length=100, blank=True)
    vin_no = models.CharField(max_length=100, blank=True)
    millage = models.CharField(max_length=100, blank=True)
    fuel_type = models.CharField(max_length=50, blank=True)
    no_of_owners = models.IntegerField(blank=True, default=1)
